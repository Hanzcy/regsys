...
@section('content')
    <div class="flex items-center justify-center mt-10 sm:mt-20 px-4 sm:px-0">
        <x-layout-main class="mx-auto w-full max-w-lg">
            <!-- Header with Logo and Title -->
            <div class="bg-[rgb(0,0,85)] text-white p-4 rounded-t-lg flex flex-col sm:flex-row items-center sm:justify-between">
                <!-- Left Logo -->
